...
{
    public function test_the_component_is_rendered_with_no_logo(): void
    {
        /** @var Package $package */
    ...
    public function test_the_component_is_rendered_with_a_logo(): void
    {
        Storage::fake('logos')
    ...
    public function test_the_component_is_rendered_with_a_logo_and_secondary_title(): void
    {
        Storage::fake('logos')
            ->put('logo.svg', file_get_contents(__DIR__ . '/../../fixtures/logo.svg'));
